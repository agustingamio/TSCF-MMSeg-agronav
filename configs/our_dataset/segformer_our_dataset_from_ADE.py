# ------------------------------------------------------------
# Combined SegFormer‐MiT-B5 config for fine‐tuning on “our_dataset”
# - Backbone: MiT‐B5 (pretrained)
# - Decoder: SegFormerHead with num_classes=5
# - Backbone frozen (lr_mult=0)
# - Crop size: 1024×1024, sliding‐window inference
# - Scheduler: 160k total iters, LinearLR warmup + PolyLR
# ------------------------------------------------------------

_base_ = [
    '../_base_/default_runtime.py',
    '../_base_/schedules/schedule_40k.py',
    '../_base_/datasets/our_dataset.py'  # Dataset config (5 classes) with pipelines
]
